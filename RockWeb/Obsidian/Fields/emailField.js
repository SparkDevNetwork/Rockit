System.register(["vue", "../Reporting/comparisonType", "./fieldType", "./utils"], function (exports_1, context_1) {
    ...
    var vue_1, comparisonType_1, fieldType_1, utils_1, editComponent, filterComponent, configurationComponent, EmailFieldType;
    ...
    return {
        ...
        execute: function () {
            ...
            filterComponent = vue_1.defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield context_1.import("./emailFieldComponents")).FilterComponent;
            }));
            ...
            exports_1("EmailFieldType", EmailFieldType);
        }
    };
});
