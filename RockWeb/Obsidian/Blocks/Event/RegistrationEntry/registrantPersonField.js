System.register(["vue", "../../../Controls/addressControl", "../../../Elements/textBox", "../../../Elements/emailBox", "../../../Elements/dropDownList", "../../../Elements/genderDropDownList", "../../../Elements/birthdayPicker", "../../../Elements/phoneNumberBox", "../../../Controls/componentFromUrl", "../../../Elements/alert", "../../../Elements/datePartsPicker"], function (exports_1, context_1) {
    "use strict";
    var vue_1, addressControl_1, textBox_1, emailBox_1, dropDownList_1, genderDropDownList_1, birthdayPicker_1, phoneNumberBox_1, componentFromUrl_1, alert_1, datePartsPicker_1;
                    ...
                    const component = vue_1.computed(() => {
                        switch (props.field.personFieldType) {
                            ...
                            case 11:
                                return dropDownList_1.default;
                            case 9:
                                return phoneNumberBox_1.default;
                            case 10:
                                return phoneNumberBox_1.default;
                            case 8:
                                return phoneNumberBox_1.default;
