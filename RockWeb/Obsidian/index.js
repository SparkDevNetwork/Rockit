System.register(["vue", "./rockBlock", "./Store/index", "./Rules/index", "./Util/rockDateTime"], function (exports_1, context_1) {
    ...
    var vue_1, rockBlock_1, index_1, rockDateTime_1, store, developerStyle;
...
<RockBlock v-else :config="config" :blockComponent="blockComponent" :startTimeMs="startTimeMs" />`
    ...
    return {
        ...
        execute: function () {
            ...
            developerStyle = vue_1.defineComponent({
                render() {
                    return vue_1.h("style", {}, this.$slots.default ? this.$slots.default() : undefined);
                }
            });
        }
    };
